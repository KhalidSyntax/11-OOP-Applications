...
public:
	...
	static void FillArrayWithRandomWords(string arr[100], int arrLength, enCharType CharType, short NumberOfKeys)
	{
		for (int i = 0; i < arrLength; i++)
			arr[i] = GenerateWord(CharType, NumberOfKeys);
	}
